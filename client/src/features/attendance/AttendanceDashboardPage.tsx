...
export function AttendanceDashboardPage(): React.ReactElement {
  ...
  const [snapshotPreview, setSnapshotPreview] = useState<{ url: string; name: string; score?: number | null | undefined; title?: string | undefined } | null>(null);
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem" }}>
              <h3 id="snapshot-modal-title" style={{ fontSize: "1.1rem", margin: 0 }}>
                {snapshotPreview.title ?? (snapshotPreview.score != null ? "Face Verification Snapshot" : "Profile Photo")}
              </h3>
              <button
                type="button"
                className="button button--ghost"
